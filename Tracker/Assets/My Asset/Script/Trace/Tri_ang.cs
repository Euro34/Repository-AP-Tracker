...
public class Tri_ang : MonoBehaviour
{
    ...
    {
        //triangulation
        double[] imgPoint1 = new double[2] { Dot_render2.dot_list[frame, 0].pos_x, Dot_render2.dot_list[frame, 0].pos_y };
        double[] imgPoint2 = new double[2] { Dot_render2.dot_list[frame, 1].pos_x, Dot_render2.dot_list[frame, 1].pos_y };
        Mat tri = new Mat();
